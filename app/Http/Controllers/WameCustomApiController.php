...
class WameCustomApiController extends WameApiController
{
    /**
    ...
    public function handle(): void
    {
        ...
        if (file_exists(app_path("{$controllerFile}"))) {
            ...
            $lines = [
                ...
                "\n",
                '            return ApiResponse::collection($data, ' . $resourceName . "::class)->code('1')->response();\n",
                "        } catch (\Exception \$e) {\n",
                ...
                "            DB::commit();\n",
                "\n",
                "            return ApiResponse::data({$resourceName}::make(\$entity))->code('1')->response(201);\n",
                "        } catch (\Exception \$e) {\n",
                "            DB::rollBack();\n",
                "            return ApiResponse::code('9')->message(\$e->getMessage())->response(500);\n",
                "        }\n",
                ...
                "            \$entity = {$name}::find(\$id);\n",
                "\n",
                "            return ApiResponse::data({$resourceName}::make(\$entity))->code('1')->response();\n",
                "        } catch (\Exception \$e) {\n",
                "            return ApiResponse::code('9')->message(\$e->getMessage())->response(500);\n",
                "        }\n",
                "    }\n",
