...
class Footer
{
    ...
    {
        Nova::footer(fn () => '<p class="text-center">Created with '
            ...
            . ' by <a href="https://github.com/PPP-Peter" target="_blank">Peter Maník</a></p>'
            . '<p class="text-center">on <a href="https://github.com/PPP-Peter/cv" target="_blank">Github</a></p>'
            . '<p class="text-center"><small>v' . Nova::version() . '</small></p>');
    }
}
